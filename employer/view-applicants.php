...
<head>
	...
	<title>JobLinkX - Applicants <?php echo "$job_title"; ?></title>
		...
		<div class="main-wrapper">
			...
			<div class="section sm">
				...
				<div class="container">
					...
					<div class="sorting-wrappper">
						...
						<div class="sorting-header">
							<h3 class="sorting-title">Accepted Applicants: <?php echo "$job_title"; ?></</h3>
						</div>
					...
					<div class="employee-grid-wrapper">
						...
						<div class="GridLex-gap-15-wrappper">
							...
							$stmt = $conn->prepare("SELECT * FROM tbl_job_applications WHERE job_id = :jobid AND application_status = 'accepted' ORDER BY id LIMIT :page1, 16");
							$stmt->bindParam(':jobid', $job_id);
							$stmt->bindParam(':page1', $page1, PDO::PARAM_INT);
							...
							
							{
								...
								?>
									...
									<div class="employee-grid-item">
										...
										<a target="_self" href="../employee-detail.php?empid=<?php echo $rowb['member_no']; ?>" class="clearfix">
							...
							?>
								...
								?>
									...
									<div class="sorting-header">
										<h3 class="sorting-title">Pending Applicants: <?php echo "$job_title"; ?></</h3>
									</div>
									<div class="employee-grid-wrapper">
						...
						<div class="GridLex-gap-15-wrappper">
							...
							<?php
							include '../constants/db_config.php';
							$stmt = $conn->prepare("SELECT * FROM tbl_job_applications WHERE job_id = :jobid AND application_status = 'pending' ORDER BY id LIMIT :page1, 16");
							$stmt->bindParam(':jobid', $job_id);
							$stmt->bindParam(':page1', $page1, PDO::PARAM_INT);
                ...
                <form action="accept_applicant.php" method="POST">
                    ...
                    <button type="submit" class= "bg-success">Accept</button>
                </form>
            </td>

            <td>
			<td>
    <form id="declineForm<?php echo $row['id']; ?>" action="decline_applicant.php" method="POST">
        <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
        <button type="button" class="bg-danger" onclick="confirmDecline(<?php echo $row['id']; ?>)">Decline</button>
    </form>

	<script>
function confirmDecline(applicationId) {
    if (confirm('This will delete the application! Do you want to continue?')) {
        // Proceed with the form submission
        document.getElementById('declineForm' + applicationId).submit();
    }
}
</script>
</td>

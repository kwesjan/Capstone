...
<head>
	...
	<title>JobLinkX - <?php echo "$jobtitle"; ?></title>
												...
												<div class="col-sm-4 col-md-4">
													...
													<div class="form-group">
														...
														<select name="department" required class="selectpicker show-tick form-control" data-live-search="true">
                                                           ...
                                                           foreach($result as $row)
                                                           {
		                                                    ?> <option <?php if ($jobdepartment == $row['dept_name']) { print 'selected'; } ?> value="<?php echo $row['dept_name']; ?>"><?php echo $row['dept_name']; ?></option> <?php
												...
												<div class="col-xss-12 col-xs-6 col-sm-6 col-md-4">
													...
													<div class="form-group mb-20">
														...
														<select name="jobtype" required class="selectpicker show-tick form-control" data-live-search="false" data-selected-text-format="count > 3" data-done-button="true" data-done-button-text="OK" data-none-selected-text="All">
															...
															<option <?php if ($jobtype == "Full-time") { print ' selected '; } ?> value="Full-time" data-content="<span class='label-dark'>Full-time</span>">Full-time</option>
															<option <?php if ($jobtype == "Part-time") { print ' selected '; } ?> value="Part-time" data-content="<span class='label-dark'>Part-time</span>">Part-time</option>
															<option <?php if ($jobtype == "Freelance") { print ' selected '; } ?> value="Freelance" data-content="<span class='label-dark'>Freelance</span>">Freelance</option>
														</select>
													</div>

...
<head>
	...
	<title>JobLinkX - Contact Us</title>
				...
				<div class="container">
					...
					<div id="navbar" class="navbar-nav-wrapper navbar-arrow">
						...
						<ul class="nav navbar-nav" id="responsive-menu">
							...
							<li>
								<a href="employees.php">UI ALUMNI</a>
							</li>
					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address> PHINMA, <br/> UNIVERSITY OF ILOILO</address>
								</li>
								<li>
										<h5>Email</h5><a href="mailto:joblinkx@gmail.com">joblinkx@gmail.com</a>
								</li>
								<li>
										<h5>Phone Number</h5><a href="tel:+12345678">+12345678</a>
								</li>

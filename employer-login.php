...
<head>
	...
	<title>JobLinkX - Employer Login</title>
...
<body class="not-transparent-header">
	...
	<div class="container-wrapper">
			...
			<div id="loginModal" class="modal fade login-box-wrapper" tabindex="-1" style="display: none;" data-backdrop="static" data-keyboard="false" data-replace="true">
				...
				<div class="modal-body">
					...
					<div class="row gap-20">
						...
						<div class="col-sm-6 col-md-6">
							<a href="admin-login.php" class="btn btn-primary btn-block mb-5-xs">Login as Admin</a>
						</div>
		...
		<div class="main-wrapper bg-dark">
			...
			<div class="breadcrumb-wrapper bg-dark">
			
				<div class="container">
				
					<ol class="breadcrumb-list bg-dark">
						<li><a href="./">Home</a></li>
			...
			<div class="login-container-wrapper bg-dark">	
					...
					<div class="row">
						...
						<div class="col-md-10 col-md-offset-1">
							...
							<div class="row">
								...
								?>
                                <form name="frm" action="app/employer-auth.php" method="POST" autocomplete="on">
                                <div class="login-box-wrapper">
							
                                <div class="modal-header bg-success">
                                <h4 class="modal-title text-center text-white">Access your account</h4>
                                </div>
...
<div class="modal-footer text-center bg-success">
					...
					<div class="row gap-20">
						...
						<div class="col-sm-12 col-md-12">
							...
							<div class="form-group"> 
								...
								<input id="mymail" autocomplete="on" name="email" class="form-control" placeholder="Enter your email address" type="email" required> 
							</div>

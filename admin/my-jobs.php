...
<body class="not-transparent-header">
							...
							<div class="GridLex-col-3_sm-4_xs-12">
								...
								<div class="admin-sidebar">
									...
									<li class="">
										...
										<li >
											<a href="users.php" class="btn btn-success btn-sm btn-inverse fa fa-user">Employees</a>
										</li>
    ...
    <div class="admin-content-wrapper">
				...
				<?php
					$page1 = 0;
						...
						try {
    						...
    						$stmt = $conn->prepare("SELECT * FROM tbl_jobs ORDER BY job_id LIMIT $page1,16");
    						$stmt->execute();
        ...
        <tr>
			...
			<td>
    			<form id="approveForm<?php echo $row['job_id']; ?>" action="approve_jobs.php" method="POST">
        		<input type="hidden" name="job_id" value="<?php echo $row['job_id']; ?>">
        		<button type="button" onclick="confirmApprove(<?php echo $row['job_id']; ?>)" class="bg-success">Approve</button>
    			</form>

    			<script>
        function confirmApprove(jobId) {
            if (confirm('This will approve the job! Do you want to continue?')) {
            ...
            <td>
			<form id="denyForm<?php echo $row['job_id']; ?>" action="deny_user.php" method="POST">
				<input type="hidden" name="id" value="<?php echo $row['job_id']; ?>">
				<button type="button" class="bg-danger" onclick="confirmDecline(<?php echo $row['job_id']; ?>)">Deny</button>
			</form>
				...
				function confirmDecline(applicationId) {
					if (confirm('This will delete the registration! Do you want to continue?')) {
						...
						document.getElementById('denyForm' + applicationId).submit();
					}
				}
				</script>
            </td>

...
<head>
	...
	<title>JobLinkX - Employees</title>
							...
							<div class="GridLex-col-3_sm-4_xs-12">
								...
								<div class="admin-sidebar">
									...
									<li class="">
										...
										<li class="active">
										<a href="users.php" class="btn btn-success btn-sm fa fa-user">Employees</a>
										</li>

                                        <li  class="">
											<a href="my-jobs.php" class="btn btn-success btn-inverse fa fa-bookmark"> Posted Jobs</a>
										</li>
...
<div class="GridLex-col-9_sm-8_xs-12">
    <div class="admin-content-wrapper">
				...
				<?php
					$page1 = 0;
						...
						try {
    						...
    						$stmt = $conn->prepare("SELECT * FROM tbl_users WHERE role = 'employee' AND approval_status = 'pending' ORDER BY id LIMIT $page1,16");
    						$stmt->execute();
        ...
        <tr>
            ...
            <td>
    			<form id="approveForm<?php echo $row['id']; ?>" action="approve_userp.php" method="POST">
    			...
    			<script>
					function confirmApprove(applicationId) {
						if (confirm('This will validate the registration! Do you want to continue?')) {
							document.getElementById('approveForm' + applicationId).submit();
							}
						}
				</script>
			</td>
            ...
            <td>
			<form id="denyForm<?php echo $row['id']; ?>" action="deny_user.php" method="POST">
				<input type="hidden" name="id" value="<?php echo $row['id']; ?>">

							...
							<div class="GridLex-col-3_sm-4_xs-12">
								...
								<div class="admin-sidebar">
									...
									<li class="">
										...
										<li class="active">
										<a href="change-password.php" class="btn btn-success btn-sm fa fa-key"> Settings</a>
										</li>
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
									...
									<form name="frm" class="post-form-wrapper" action="app/new-pass.php" method="POST">
											...
											<div class="row gap-20">
                                             <?php include 'constants/check_reply.php'; ?>
												...
												<div class="col-sm-12 mt-10">
													<button type="submit" onclick="return check_passwords();" class="btn btn-success">Update</button>
													<button type="reset" class="btn btn-success btn-inverse">Cancel</a>
												</div>
										...
										?><a onclick = "return confirm('Are you sure you want to delete your logo ?')" class="btn btn-success btn-inverse" href="app/drop-dp.php">Delete</a> <?php
										}
										?>
										</div>
										</div>

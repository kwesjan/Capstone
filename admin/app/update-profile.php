...
$myemail = $_POST['email'];
    ...
    $stmt = $conn->prepare("SELECT * FROM tbl_admin WHERE email = :email AND member_no != '$myid'");
	...
	if ($rec == "0") {
    $stmt = $conn->prepare("UPDATE tbl_admin SET first_name = :compname, byear = :esta, title = :type, city = :city, street = :street, zip = :zip, country = :country, phone = :phone, about = :about, services = :service, expertise = :expertise, people = :people, website = :website WHERE member_no='$myid'");

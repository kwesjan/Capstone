...
<form name="frm" action="app/create-account.php" method="POST" autocomplete="on">
...
<div class="form-group"> 
<label>School Issued ID</label>
<input class="form-control" placeholder="Enter your ID" name="sch_id" required type="text"> 
</div>

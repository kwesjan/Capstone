				...
				<div class="container">
					...
					<div class="sorting-wrappper">
						...
						<div class="sorting-header">
							<h3 class="sorting-title text-white">Alumni</h3>
						</div>
					...
					<div class="employee-grid-wrapper">
						...
						<div class="GridLex-gap-15-wrappper">
                            ...
                            $stmt = $conn->prepare("SELECT * FROM tbl_users WHERE role = 'employee' AND user_status = 'active' ORDER BY first_name LIMIT $page1,16");
                            $stmt->execute();
                            ...
                            foreach($result as $row)
                            {
								...
								?>
									...
									<div class="employee-grid-item">
										...
										<a target="_self" href="employee-detail.php?empid=<?php echo $row['member_no']; ?>" class="clearfix">
											...
											<div class="content text-white">
												...
												<h4 class="text-white"><?php echo $row['first_name'] ?> <?php echo $row['last_name'] ?></h4>
												<p class="location"><i class="fa fa-map-marker"></i> <?php echo $row['country'] ?></p>
												
												<h6 class="text-white">Education : <?php echo $row['education'] ?></h6>
												
                                                <h6 class="text-white"><?php echo $row['title'] ?></h6>

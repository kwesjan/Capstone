...
<head>
	...
	<title>JobLinkX - Alumni Login</title>
				...
				<div class="modal-body">
					...
					<div class="row gap-20">
						...
						<div class="col-sm-6 col-md-6">
							<a href="employer-login.php?" class="btn btn-primary btn-block mb-5-xs">Login as Employer</a>
						</div>
					...
					<div class="row">
						...
						<div class="col-md-10 col-md-offset-1">
							...
							<div class="row">
								...
								include 'constants/check_reply.php';	
								?>
                                <form name="frm" action="app/auth.php" method="POST" autocomplete="on">

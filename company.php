...
$company_id = $_GET['ref'];
    ...
    $stmt = $conn->prepare("SELECT * FROM tbl_employers WHERE member_no = :memberno AND role = 'employer'");
...
<head>
	...
	<title>JobLinkX - <?php echo "$compname"; ?></title>
								...
								<div class="company-detail-wrapper">
									...
									<div class="company-detail-header text-center">
										...
										<ul class="meta-list clearfix">
											<li>
												<h4 class="heading text-center">Established In:</h4>
												<?php echo "$compesta"; ?>
											</li>
											<li>
												<h4 class="heading text-center">Type:</h4>
												<?php echo "$comptype"; ?>
											</li>
									...
									<div class="section-title mb-40">
										...
										<h2 class="text-center">Jobs offered at <?php echo "$compname"; ?></h2>

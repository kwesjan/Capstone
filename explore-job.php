...
$stmt = $conn->prepare("SELECT * FROM tbl_employers WHERE member_no = '$compid'");
$stmt->execute();
$result = $stmt->fetchAll();
...
<head>
	...
	<title>JobLinkX - Jobs - <?php echo "$jobtitle"; ?></title>
   ...
   function update(str)
   {
	...
	var txt;
    var r = confirm("Are you sure you want to apply on this job?");
    if (r == true) {
			...
			<div id="registerModal" class="modal fade login-box-wrapper" tabindex="-1" style="display: none;" data-backdrop="static" data-keyboard="false" data-replace="true">
				...
				<div class="modal-body">
					...
					<div class="row gap-20">
						...
						<div class="col-sm-6 col-md-6">
							<a href="register.php?p=Employee" class="btn btn-facebook btn-block mb-5-xs">Register as Alumni</a>
						</div>
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						...
						<li><a target="_self" href="company.php?ref=<?php echo "$compid"; ?>"><?php echo "$compname"; ?></a></li>
							...
							<div class="job-detail-wrapper">
								...
								<div class="job-detail-header text-center">
									...
									<div class="meta-div clearfix mb-25">
										<span>at <a target="_self" href="company.php?ref=<?php echo "$compid"; ?>"><?php echo "$compname"; ?></a> as </span>
										<?php echo "$sta"; ?>
									</div>

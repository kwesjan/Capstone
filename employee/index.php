...
<head>
	...
	<title>JobLinkX - Employee Profile</title>
						...
						<div class="GridLex-grid-noGutter-equalHeight">
							...
							<div class="GridLex-col-3_sm-4_xs-12">
								...
								<div class="admin-sidebar">
									...
									<li class="active">
											<a href="./" class="btn btn-success btn-sm btn-sm fa fa-user">Profile</a>
										</li>
										<li class="">
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
									...
									<form class="post-form-wrapper" action="app/update-profile.php" method="POST" autocomplete="on">

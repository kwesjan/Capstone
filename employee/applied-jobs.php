...
<head>
	...
	<title>JobLinkX - Applied Jobs</title>
						...
						<div class="GridLex-grid-noGutter-equalHeight">
							...
							<div class="GridLex-col-3_sm-4_xs-12">
								...
								<div class="admin-sidebar">
									...
									<li>
											<a href="./" class="btn btn-success btn-inverse btn-sm fa fa-user">Profile</a>
										</li>
										<li class="">
										<a href="change-password.php"class="btn btn-success btn-inverse btn-sm fa fa-key"> Change Password</a>
										</li>
										<li class="active">
											<a href="applied-jobs.php"class="btn btn-success btn-sm fa fa-bookmark"> Applied Jobs</a>
										</li>

										<li>
											<a href="attachments.php"class="btn btn-success btn-inverse btn-sm fa fa-file"> MY DOCUMENTS</a>
										</li>
										
										<li>
											<a href="../logout.php"class="btn btn-success btn-inverse btn-sm fa fa-sign-out"> Logout</a>
										</li>
									</ul>
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
                                  ...
                                  foreach($result as $row)
                                  {
									...
									$stmtc = $conn->prepare("SELECT * FROM tbl_employers WHERE member_no = '$compid' AND role = 'employer'");
                                    $stmtc->execute();
									...
									?>
																	   <a target="_self" href="../explore-job.php?jobid=<?php echo "$job_id"; ?>" class="recent-job-item clearfix">

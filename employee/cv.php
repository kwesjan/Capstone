						...
						<div class="GridLex-grid-noGutter-equalHeight">
							...
							<div class="GridLex-col-3_sm-4_xs-12">
								...
								<div class="admin-sidebar">
									...
									<li class="">
										...
										<li class="">
										<a href="change-password.php"class="btn btn-success btn-inverse fa fa-key"> Change Password</a>
										</li>
										<li>
											<a href="applied-jobs.php"class="btn btn-success btn-inverse btn-sm fa fa-bookmark"> Applied Jobs</a>
										</li>

                                        <li class= "">
											<a href="cv.php"class="btn btn-success btn-sm btn-sm fa fa-bookmark"> MY DOCUMENTS</a>
										</li>
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
									...
									<form name="frm" class="post-form-wrapper" action="app/add-cv.php" method="POST">
								
                                    <div class="form-group">
                                        <label for="cvFile">Attach CV</label>
                                        <input type="file" name="cvFile" id="cvFile" accept=".pdf,.doc,.docx">
                                        <p class="help-block">Upload your CV in PDF or Word format.</p>
                                    </div>

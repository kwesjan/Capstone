				...
				<div class="container">
						...
						<div class="GridLex-grid-middle">
							...
							<div class="GridLex-col-3_sm-12_xs-12">
								...
								<div class="sorting-header">
									<h3 class="sorting-title text-white">Employers</h3>
								</div>
					...
					<div class="company-grid-wrapper top-company-2-wrapper">
						...
						<div class="GridLex-gap-30">
                            ...
                            $stmt = $conn->prepare("SELECT * FROM tbl_employers WHERE role = 'employer' AND user_status = 'active' ORDER BY first_name LIMIT $page1,16");
                            $stmt->execute();
							...
							<a target="_self" href="company.php?ref=<?php echo $row['member_no']; ?>">
							...
							<div class="content">
							<h5 class="heading font700 text-white"><?php echo $row['first_name'];?></h5>
